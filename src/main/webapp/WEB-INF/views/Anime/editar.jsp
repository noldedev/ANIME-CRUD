				...
				<div class="card-body">
					<form:form action="" method="post" name="" modelAttribute="anime">
						...
						<div>
							...
							<img src="data:image/${anime.imagenes.getTypeImage()};base64,${anime.imagenes.getBase64Image()}"  width="300px" height="300px"/>
						</div>
						<div class="mb-3">
						...
						Imagen Cambiado: <br> 
						<img id="imageId" width="200px" height="200px" class="img-thumbnail border border-primary mb-4"><br>
						
						<div class="row row-cols-2 mx-auto">
							<button class="btn btn-success mt-2 rounded" type="submit">Editar</button>
